function [pred,r,p,mse] = mTRFpredict_modified(stim,resp,trf,eeg_sampling_rate_downsampled_Hz,mapping,epoch_lower_cutoff_ms,epoch_higher_cutoff_ms,model_constant_intra_subject_average)
